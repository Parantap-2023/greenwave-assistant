...
import { Bot, Send, Leaf, X, Sparkles } from "lucide-react";
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      ...
      if (lowercaseInput.includes("carbon") || lowercaseInput.includes("footprint")) {
        ...
        responseText = "That's an interesting question about sustainability! While I'm just a demo version with limited knowledge, a fully implemented EcoBot would be able to provide detailed information on various sustainability topics, calculate emissions for specific activities, and offer personalized recommendations based on your lifestyle.";
      }
